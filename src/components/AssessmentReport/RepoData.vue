<template>
    ...
    <div class="row repo_data">
      <div v-if="repo.avatar_url" class="col-auto text-center">
      ...
      <div class="col-auto">
        <div class="row">
          <div class="col repo_data_name .text-center">

            <span v-if="assessmentType === 'fair'" style="font-size: 26px; color: #6c757d; font-weight: bold; margin-right: 5px;"> Dataset PID: </span> <a :href='repo.url' target="_blank" style="font-size: 36px; font-weight: bold;"> {{ this.$store.state.report.repository[0].name }} </a>

          </div>
        </div>

        <div class="row">
          <div v-if="repo.description" class="col repo_data_description mb-2">
        ...
        <div class="row">
          ...
          <div v-if="repo.tag" class="col-auto repo_data_version mb-2">
          ...
          <div v-if="repo.languages" class="col-auto repo_data_languages mb-2">
          ...
          <div v-if="repo.topics" class="col-auto repo_data_topics mb-2">
        ...
        <div class="row">
          <div v-if="repo.watchers_count" class="col-auto repo_data_watchers mb-2">
          ...
          <div v-if="repo.forks_count" class="col-auto repo_data_forks mb-2">
          ...
          <div v-if="repo.stargazers_count" class="col-auto repo_data_stars mb-2">
            <svg  height="16" width="16" viewBox="0 0 16 16" >
